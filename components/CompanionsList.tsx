    ...
    import { Table, TableBody, TableCaption, TableCell, TableHead, TableHeader, TableFooter, TableRow } from './ui/table'
    ...
    <TableBody>
        {companions?.map(({id, subject, name, topic, duration}) =>(
            <TableRow key={id}>
                ...
                <TableCell>
                    <div className='flex items-center gap-2 w-full jusitfy-end'>
